...
__all__ = [
    ...
    'DISPID_SRCRetainedAudio', 'SREFalseRecognition', 'SVP_17',
    'SGDSActive', 'SPSTREAMFORMATTYPE', 'SpeechWordType',
    'eLEXTYPE_PRIVATE6', 'ISpeechBaseStream',
    'DISPID_SRGSetWordSequenceData', 'SPAUDIOOPTIONS',
    'eLEXTYPE_RESERVED7', 'DISPID_SREmulateRecognition', 'SDTAudio',
    'DISPID_SVGetProfiles', 'SP_VISEME_15', 'SPINTERFERENCE_TOOQUIET',
    'SGSDisabled', 'DISPID_SFSClose', 'DISPID_SVSpeakCompleteEvent',
    'ISpSerializeState', 'DISPID_SRSCurrentStreamPosition',
    'ISpeechGrammarRules', 'SRSInactiveWithPurge', 'SPAO_NONE',
    'SPEI_RECO_STATE_CHANGE', 'SAFT8kHz8BitMono', 'SPSVerb',
    'eLEXTYPE_RESERVED9', 'ISpeechVoiceStatus', 'SDTAlternates',
    'SWTAdded', 'SPSHT_EMAIL', 'ISpeechAudio', 'SPAS_PAUSE',
    'SPFM_OPEN_READONLY', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechPhraseProperty',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SP_VISEME_3',
    'SAFT24kHz8BitMono', 'SPAO_RETAIN_AUDIO', 'SDKLDefaultLocation',
    'SAFT32kHz16BitMono', 'tagSPPROPERTYINFO', 'DISPID_SVGetVoices',
    'SDTAll', 'DISPID_SRProfile', 'SGRSTTEpsilon',
    'DISPID_SASCurrentSeekPosition', 'eLEXTYPE_PRIVATE18',
    'SPRS_INACTIVE', 'DISPID_SpeechRecoResult',
    'SpObjectTokenCategory', 'SGDSActiveWithAutoPause', 'SP_VISEME_1',
    'SGRSTTTextBuffer', 'DISPID_SASetState', 'SAFT11kHz8BitMono',
    'SFTInput', 'SpeechRuleAttributes',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SECLowConfidence', 'DISPID_SpeechVoice', 'SPSHORTCUTTYPE',
    'SPCATEGORYTYPE', 'SAFT24kHz16BitStereo', 'SPEI_TTS_BOOKMARK',
    'SpeechVisemeType', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRCEBookmark', 'SRTReSent',
    'DISPID_SpeechFileStream', 'SpStreamFormatConverter',
    'ISpeechMMSysAudio', 'DISPID_SRRAlternates',
    'SAFT22kHz8BitStereo', 'SPRST_ACTIVE_ALWAYS', 'SPPS_Function',
    'DISPID_SVEWord', 'SPBO_PAUSE', 'DISPID_SGRSTRule',
    'SPDKL_LocalMachine', 'DISPID_SpeechVoiceStatus',
    'DISPID_SAFGuid', 'DISPID_SVGetAudioInputs', 'SECFIgnoreCase',
    'SPEI_MIN_TTS', 'DISPID_SPEs_NewEnum', 'SpLexicon',
    ...
    'DISPID_SMSSetData', 'SPPS_SuppressWord', 'SPBO_TIME_UNITS',
    'ISpeechPhraseProperty', 'SpeechPropertyHighConfidenceThreshold',
    'ISpeechVoice', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SWFEChannels', 'SPWORDPRONUNCIATIONLIST', 'SRCS_Enabled',
    'SVSFParseAutodetect', 'SAFTCCITT_ALaw_44kHzMono',
    'eLEXTYPE_PRIVATE4', 'SPFM_OPEN_READWRITE', 'SPGS_DISABLED',
    'SRTExtendableParse', 'DISPID_SPEEngineConfidence',
    'SpeechDisplayAttributes', 'DISPID_SVSLastResult',
    'SPPS_RESERVED1', 'DISPID_SDKGetlongValue', 'DISPID_SMSALineId',
    'SDA_No_Trailing_Space', 'ISpDataKey',
    'SpeechDictationTopicSpelling', 'SAFT11kHz16BitStereo',
    'DISPID_SLWPronunciations', 'DISPID_SRGRecoContext', 'SITooLoud',
    'DISPID_SRRGetXMLResult', 'DISPID_SVSkip',
    'DISPID_SGRSTNextState', 'SP_VISEME_10', 'DISPID_SAVolume',
    'DISPID_SRSNumberOfActiveRules', 'ISpStreamFormatConverter',
    'SpTextSelectionInformation', 'SRSInactive', 'IEnumString',
    'SPPS_RESERVED4', 'SAFTNonStandardFormat', 'SDTDisplayText',
    'DISPID_SPCLangId', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpResourceManager', 'SPWORDPRONUNCIATION',
    'SVEStartInputStream', 'ISpeechDataKey', 'SPSModifier',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechPhraseInfo',
    'DISPID_SDKSetLongValue', 'SAFT44kHz8BitMono', 'SPAR_Medium',
    'DISPID_SGRSTType', 'DISPID_SPRDisplayAttributes',
    'DISPID_SGRSAddRuleTransition', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPIGetText', 'SVSFNLPMask', 'SVP_1', 'SAFT16kHz16BitMono',
    'SREAudioLevel', 'SPEI_RESERVED1', 'ISpeechPhraseRules',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPIProperties',
    'DISPID_SVEViseme', 'SPAS_RUN', 'DISPID_SOTCSetId',
    'SRERequestUI', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechPropertyResourceUsage', 'SpeechGrammarTagWildcard',
    'DISPID_SVRate', 'DISPID_SPEPronunciation',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SDKDeleteKey',
    'DISPID_SRCRequestedUIType', 'SAFTGSM610_22kHzMono',
    'SpeechFormatType', 'eLEXTYPE_LETTERTOSOUND', 'DISPIDSPTSI',
    'DISPID_SLWWord', 'ISpeechPhraseProperties', 'SWTDeleted',
    'DISPID_SGRs_NewEnum', 'SRCS_Disabled', 'SPWT_PRONUNCIATION',
    'SPINTERFERENCE_TOOFAST', 'ISpRecoCategory', 'SSTTWildcard',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SLGetGenerationChange', 'DISPID_SRCEAudioLevel',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE20',
    'SAFTADPCM_22kHzStereo', 'SPPS_RESERVED3',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRGDictationSetState',
    'SpeechVoiceEvents', 'SPAUDIOSTATE', 'DISPID_SPPParent',
    'SpeechPropertyResponseSpeed', 'SPRULE', 'SPEI_RECOGNITION',
    'DISPID_SRCEHypothesis', 'ISpeechCustomStream',
    'DISPID_SGRSTText', 'SAFT48kHz16BitStereo', 'SpeechTokenKeyUI',
    'SpeechTokenKeyAttributes', 'ISpeechRecoResultDispatch',
    'DISPID_SPEDisplayText', 'SVP_9', 'SAFT16kHz8BitMono',
    'SPEI_SR_AUDIO_LEVEL', 'SPBO_NONE', 'SpShortcut', 'SVSFIsXML',
    ...
    'SPVPRI_ALERT', 'DISPID_SRSCurrentStreamNumber', 'SPWORD',
    'SAFT11kHz16BitMono', 'DISPID_SPRuleChildren',
    'SWPUnknownWordPronounceable', 'SpeechAudioProperties',
    'DISPID_SpeechXMLRecoResult', 'SPTEXTSELECTIONINFO',
    'DISPID_SABufferInfo', 'SPEI_MIN_SR', 'DISPID_SLPPhoneIds',
    'ISpMMSysAudio', 'SPPS_Unknown', 'SAFTADPCM_8kHzStereo',
    'ISpRecoGrammar2', 'SPWF_INPUT', 'SDTPronunciation',
    'SPDKL_CurrentConfig', 'SRTSMLTimeout', 'ISpeechLexiconWord',
    'SpeechTokenIdUserLexicon', 'SP_VISEME_6', 'ISpPhoneConverter',
    'DISPID_SRSClsidEngine', 'IStream', 'SpeechEngineConfidence',
    'eLEXTYPE_RESERVED6', 'SpeechTokenShellFolder', 'SBONone',
    'SpeechTokenValueCLSID', 'DISPID_SRGDictationUnload', 'SVP_10',
    'SWPUnknownWordUnpronounceable', 'SRAInterpreter',
    'DISPID_SOTCreateInstance', 'SpeechRecoEvents', 'SECFIgnoreWidth',
    'DISPID_SOTSetId', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SRATopLevel', 'tagSTATSTG', 'SpeechAudioState', 'SVP_7',
    'ISpeechRecoResultTimes', 'DISPID_SAFType', 'SSFMOpenReadWrite',
    'SP_VISEME_8', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVSFVoiceMask',
    'DISPID_SVStatus', 'SPBO_AHEAD', 'SVP_8', 'DISPID_SVVolume',
    'DISPID_SVSpeak', 'SAFT24kHz8BitStereo',
    'DISPID_SRRSetTextFeedback', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRAudioInput', 'SGPronounciation', 'DISPID_SPACommit',
    'Speech_StreamPos_RealTime', 'SPEI_TTS_PRIVATE', 'SVP_20',
    'ISpeechPhraseElement', 'SPSMF_UPS', 'DISPID_SRIsUISupported',
    'DISPID_SRGDictationLoad', 'SpeechDiscardType', 'DISPIDSPRG',
    'DISPID_SRRRecoContext', 'DISPID_SGRAttributes', 'SPRECOSTATE',
    'STCInprocServer', 'DISPID_SRRTLength',
    'DISPID_SRCEPropertyNumberChange', 'SAFT11kHz8BitStereo',
    'eLEXTYPE_PRIVATE15', 'SPEI_VOICE_CHANGE', 'SpeechPartOfSpeech',
    'DISPID_SGRSTs_NewEnum', 'SREStreamEnd', 'SVP_18',
    'SDKLCurrentConfig', 'DISPID_SLPs_NewEnum', 'eLEXTYPE_PRIVATE9',
    'SAFTTrueSpeech_8kHz1BitMono', 'SGRSTTRule',
    'DISPID_SpeechPhraseReplacements', 'SAFT44kHz16BitStereo',
    'SAFTDefault', 'DISPID_SGRSRule', 'SRADynamic',
    'DISPID_SVAudioOutput', 'ISpObjectToken',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SVSLastBookmark',
    'SPEI_MAX_SR', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPWF_SRENGINE', 'DISPID_SGRClear', 'SPEVENT', 'SRSEDone',
    'SVP_13', 'SAFT12kHz8BitStereo', 'SpeechRetainedAudioOptions',
    'IInternetSecurityMgrSite', 'DISPID_SVEBookmark',
    'SpeechCategoryRecognizers', 'SAFTExtendedAudioFormat',
    'ISpLexicon', 'SpeechVoicePriority', 'eLEXTYPE_RESERVED4',
    'DISPID_SLWsItem', 'ISpeechAudioStatus',
    'DISPID_SpeechGrammarRule',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPIDSPTSI_SelectionLength', 'SPFM_CREATE', 'SVSFUnusedFlags',
    'SRESoundStart', 'SpeechGrammarTagDictation',
    'DISPID_SpeechLexiconPronunciation', 'SpeechBookmarkOptions',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_FALSE_RECOGNITION',
    'SRERecognition', 'SPCONTEXTSTATE', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechUserTraining', 'DISPID_SPIRetainedSizeBytes',
    'ISpNotifySink', 'DISPID_SWFEExtraData', 'Speech_StreamPos_Asap',
    'SP_VISEME_14', 'SpInprocRecognizer', 'DISPID_SRCState',
    'SpeechTokenContext', 'eLEXTYPE_PRIVATE8', 'SVEAllEvents',
    'DISPID_SGRSTransitions', 'SPEI_RESERVED3',
    'DISPID_SVEVoiceChange', 'SAFT44kHz16BitMono', 'SPSHT_OTHER',
    'DISPID_SPPValue', 'SpUnCompressedLexicon', 'SPVPRI_OVER',
    'WAVEFORMATEX', 'DISPID_SPRs_NewEnum', 'SREPropertyNumChange',
    'SpeechPropertyAdaptationOn', 'SPFM_NUM_MODES',
    'DISPID_SPPConfidence', 'DISPID_SRCBookmark',
    'DISPID_SpeechRecoResultTimes', 'SpeechAllElements',
    'DISPID_SAFGetWaveFormatEx', 'SREHypothesis', 'SDKLLocalMachine',
    'SpeechVoiceSkipTypeSentence', 'SpeechLoadOption',
    'DISPID_SRGIsPronounceable', 'DISPID_SPIEnginePrivateData',
    'SpMMAudioEnum', 'DISPID_SRCCreateGrammar',
    ...
    'ISpeechWaveFormatEx', 'SAFT48kHz16BitMono',
    'Speech_Default_Weight', 'SSSPTRelativeToEnd', 'DISPID_SOTId',
    'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCAudioInInterferenceStatus', 'SPSERIALIZEDPHRASE',
    'DISPID_SPAStartElementInResult', 'DISPID_SpeechLexiconProns',
    'DISPID_SPRNumberOfElements', 'DISPID_SPERequiredConfidence',
    'STCRemoteServer', 'DISPID_SRStatus', 'ISpAudio',
    'DISPID_SpeechRecoResult2', 'SGSEnabled', 'DISPID_SPAs_NewEnum',
    'DISPID_SOTRemove', 'SVSFlagsAsync', 'ISpeechRecoResult2',
    'SPVPRI_NORMAL', 'SPAUDIOBUFFERINFO', 'SpMemoryStream',
    ...
    'eLEXTYPE_PRIVATE11', 'DISPID_SPAsItem', 'SSFMOpenForRead',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SpeechRuleState',
    'SpeechCategoryAudioOut', 'SGLexical',
    'DISPID_SRSetPropertyString', 'tagSPTEXTSELECTIONINFO',
    'SAFT48kHz8BitStereo', 'ISpRecognizer', 'SREStateChange',
    'eLEXTYPE_PRIVATE2', 'SAFT22kHz8BitMono', 'STCLocalServer',
    'SpPhoneConverter', 'SVP_0', 'SP_VISEME_18', 'SPRS_ACTIVE',
    'DISPID_SLWType', 'ISpNotifyTranslator',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPEAudioSizeTime',
    'ISpeechPhraseElements', 'SPCS_ENABLED',
    'DISPID_SRGetRecognizers', 'ISpeechFileStream', 'DISPID_SPPId',
    'DISPID_SGRSTPropertyId', 'eLEXTYPE_PRIVATE10',
    'SPEI_START_INPUT_STREAM', 'SITooSlow', 'SPSUnknown',
    'DISPID_SpeechPhraseElements', 'SPEI_ADAPTATION',
    'SAFT16kHz16BitStereo', 'SVEWordBoundary', 'SPCS_DISABLED',
    'DISPID_SpeechCustomStream', 'SRERecoOtherContext',
    'DISPID_SVEStreamStart', 'SREInterference',
    'DISPID_SLAddPronunciation', 'DISPID_SAEventHandle', 'SVPNormal',
    'SP_VISEME_2', 'SpSharedRecognizer', 'SPEI_RESERVED5',
    'DISPID_SRGId', 'SAFT22kHz16BitStereo',
    'DISPID_SRRGetXMLErrorInfo', 'SPSHORTCUTPAIRLIST',
    'SpeechRecoContextState', 'DISPID_SDKEnumKeys', 'SpMMAudioOut',
    'SpResourceManager', 'SRESoundEnd', 'UINT_PTR',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SMSADeviceId',
    'ISequentialStream', 'SVP_6', 'ISpeechLexiconPronunciation',
    'DISPID_SVESentenceBoundary', 'DISPID_SASState', 'SASClosed',
    'SPXMLRESULTOPTIONS', 'SVSFIsNotXML', 'SSTTTextBuffer',
    'SBOPause', 'SRAExport', 'SPGS_EXCLUSIVE',
    'SSSPTRelativeToCurrentPosition', 'SPRST_ACTIVE',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVSFPersistXML', 'SAFTText', 'DISPID_SVDisplayUI',
    'SPEI_SOUND_START', 'SAFT32kHz8BitMono',
    'DISPID_SpeechPhraseRules', 'DISPID_SRRTimes', 'SPPROPERTYINFO',
    ...
    'DISPID_SRIsShared', 'SSFMCreate', 'SPCT_COMMAND',
    'SRSActiveAlways', 'DISPID_SpeechPhraseProperties',
    'SPRST_NUM_STATES', 'eLEXTYPE_PRIVATE7', 'ISpGrammarBuilder',
    'SpeechAudioFormatType', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPAUDIOSTATUS', 'SP_VISEME_12', 'SAFT22kHz16BitMono',
    'DISPID_SBSWrite', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRCEInterference', 'DISPID_SRCEEnginePrivate',
    'DISPID_SASCurrentDevicePosition', 'SPAR_Low',
    'SpNullPhoneConverter', 'SVP_5', 'DISPID_SPEsCount',
    ...
    'SpeechAddRemoveWord', 'DISPID_SDKEnumValues',
    'SPEI_END_INPUT_STREAM', 'SPEI_TTS_AUDIO_LEVEL',
    'SAFT12kHz16BitStereo', '__MIDL_IWinTypes_0009', 'ISpStream',
    'DISPID_SOTDisplayUI', 'SGRSTTWord', 'DISPID_SPRulesCount',
    'DISPID_SLPsItem', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechGrammarWordType', 'DISPID_SOTCDefault',
    'DISPID_SPPChildren', 'SPEI_SR_PRIVATE', 'DISPID_SBSFormat',
    'DISPID_SVPriority', 'DISPID_SAStatus', 'SGRSTTWildcard',
    'DISPID_SVSRunningState', 'DISPID_SRDisplayUI', 'SINone',
    'SPPHRASERULE', 'SAFT24kHz16BitMono', 'SPWT_DISPLAY',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SABIEventBias',
    '_RemotableHandle', 'SPEVENTSOURCEINFO', 'DISPID_SRGRules',
    'ISpShortcut', 'DISPID_SAFSetWaveFormatEx',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRRAudio', 'DISPID_SpeechLexiconWord',
    'eLEXTYPE_RESERVED10', 'DISPID_SGRsDynamic',
    'DISPID_SPCPhoneToId', 'SPSFunction', 'ISpeechPhraseReplacements',
    'SPCT_SUB_DICTATION', 'STCInprocHandler',
    'DISPID_SRCCmdMaxAlternates', 'SpInProcRecoContext',
    'SpeechVoiceSpeakFlags', 'SpeechCategoryRecoProfiles',
    'ISpStreamFormat', 'DISPID_SDKOpenKey', 'SP_VISEME_11',
    'SPFILEMODE', 'SP_VISEME_9', 'DISPID_SPRsCount',
    'ISpRecoContext2', 'SPPS_NotOverriden', 'SPEI_PHONEME',
    'SPWORDLIST', 'DISPID_SPRFirstElement',
    'DISPID_SVSInputWordLength', 'SPPHRASE', 'SPSHT_NotOverriden',
    'ISpeechLexiconWords', 'SPINTERFERENCE_TOOSLOW', 'SPEI_RESERVED6',
    'SPBOOKMARKOPTIONS', 'DISPID_SPISaveToMemory',
    'ISpObjectWithToken', 'eLEXTYPE_PRIVATE3', 'SAFT8kHz8BitStereo',
    'SAFTADPCM_44kHzStereo', 'SRSEIsSpeaking', 'SSTTDictation',
    'DISPID_SVEAudioLevel', 'DISPID_SpeechObjectTokens', 'SRAImport',
    'eLEXTYPE_PRIVATE14', 'eLEXTYPE_PRIVATE16', 'SPAS_CLOSED',
    'SDA_Two_Trailing_Spaces', 'SRTStandard',
    'ISpeechObjectTokenCategory', 'SAFT32kHz8BitStereo', 'SpStream',
    'SPLEXICONTYPE', 'SRTAutopause', 'DISPID_SVEStreamEnd',
    'eLEXTYPE_RESERVED8', 'DISPID_SGRSTPropertyValue',
    'DISPID_SADefaultFormat', 'DISPID_SRCERecognition',
    'SAFTGSM610_44kHzMono', 'DISPID_SPPFirstElement', 'ISpProperties',
    'DISPID_SLGetWords', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPAsCount', 'DISPID_SGRSTsCount', 'DISPID_SPRText',
    'SPRECORESULTTIMES', 'DISPID_SpeechAudioStatus', 'SVP_15',
    'SpPhoneticAlphabetConverter', 'ISpRecoResult',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpMMAudioIn',
    'DISPID_SpeechDataKey', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechRecoContextEvents', 'ISpEventSource',
    'ISpPhoneticAlphabetSelection', 'eLEXTYPE_PRIVATE1',
    'SpeechGrammarState', 'SVSFParseSapi', 'DISPID_SRCVoice',
    ...
    'SPEI_SOUND_END', 'DISPID_SRCERecognizerStateChange',
    'SREBookmark', 'DISPID_SVVoice', 'SECFNoSpecialChars',
    'DISPID_SRCEAdaptation', 'DISPID_SVSPhonemeId', 'ISpVoice',
    'DISPID_SFSOpen', 'SLODynamic', 'SVP_12', 'SAFT12kHz16BitMono',
    'DISPID_SLWs_NewEnum', 'SpeechDataKeyLocation',
    'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPIElements',
    'DISPID_SRGReset', 'SLTUser', 'ISpeechAudioBufferInfo',
    'SPINTERFERENCE_TOOLOUD', 'SVSFIsFilename', 'SPAS_STOP',
    'SPLOADOPTIONS', 'SPWT_LEXICAL', 'SDTProperty',
    'SpeechWordPronounceable', 'SpeechRegistryUserRoot',
    'DISPID_SPPEngineConfidence', 'SDTLexicalForm',
    'DISPID_SRGetPropertyNumber', 'eLEXTYPE_USER_SHORTCUT',
    'SpeechMicTraining', 'SpWaveFormatEx', 'eLEXTYPE_PRIVATE12',
    'SVEVoiceChange', 'DISPID_SOTsItem', 'DISPID_SRRAudioFormat',
    'SVP_4', 'SPSNotOverriden', 'ISpeechGrammarRuleState',
    'SPPHRASEREPLACEMENT', 'SVP_3', 'SpeechAudioVolume',
    'DISPID_SRCEventInterests', 'SVF_None', 'DISPID_SGRAddResource',
    'DISPID_SLWLangId', 'DISPID_SVSInputSentencePosition',
    'ISpeechPhraseInfoBuilder', 'ISpPhraseAlt',
    'SpeechGrammarTagUnlimitedDictation', 'SDTRule',
    'DISPID_SPIStartTime', 'ISpNotifySource',
    'DISPID_SPRules_NewEnum', 'ISpeechRecoGrammar',
    'DISPID_SGRInitialState', 'DISPID_SPRuleId',
    'SPADAPTATIONRELEVANCE', 'SP_VISEME_0', 'SAFT44kHz8BitStereo',
    'DISPID_SGRSTsItem', 'DISPID_SRCESoundEnd',
    'DISPID_SPAPhraseInfo', 'SPEVENTENUM', 'SVSFDefault',
    'SINoSignal', 'SPINTERFERENCE', 'DISPID_SDKSetStringValue',
    'DISPID_SRRPhraseInfo', 'DISPID_SRCEEndStream',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE5', 'SPCT_SLEEP',
    'SRADefaultToActive', 'DISPID_SWFEFormatTag',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SGRsCommitAndSave',
    'SPFM_CREATE_ALWAYS', 'DISPID_SGRSTPropertyName', 'SPRULESTATE',
    ...
    'SPPHRASEELEMENT', 'SP_VISEME_17', 'SpeechStreamSeekPositionType',
    'SVF_Emphasis', 'SPVOICESTATUS', 'ISpeechLexicon',
    'SPPS_Modifier', 'DISPID_SpeechAudioFormat',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_19',
    'DISPID_SpeechBaseStream', 'DISPID_SLWsCount', 'SFTSREngine',
    'SP_VISEME_16', 'DISPID_SVSInputWordPosition', 'SPAR_High',
    'DISPID_SpeechGrammarRuleState', 'SP_VISEME_21',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechRecognizer', 'SINoise',
    'DISPID_SBSSeek', 'DISPID_SRCERequestUI',
    'SpeechPropertyComplexResponseSpeed', 'SAFTCCITT_ALaw_8kHzMono',
    'SPCT_SUB_COMMAND', 'DISPID_SRAudioInputStream',
    'ISpeechRecoResult', 'DISPID_SVSpeakStream', 'DISPID_SVEPhoneme',
    'eWORDTYPE_ADDED', 'DISPID_SOTsCount',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFT8kHz16BitStereo',
    'DISPID_SVAudioOutputStream', 'DISPID_SVEventInterests',
    'SVEBookmark', 'eLEXTYPE_PRIVATE13', 'Speech_Max_Pron_Length',
    'SPSLMA', 'SASStop', 'DISPID_SPRuleName', 'DISPID_SPIGrammarId',
    'SPXRO_SML', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SpeechPhoneConverter',
    'DISPID_SOTGetAttribute', 'IEnumSpObjectTokens', 'SPPS_Noun',
    'SpeechPropertyLowConfidenceThreshold', 'ISpeechPhraseAlternate',
    'SPEI_REQUEST_UI', 'DISPID_SVPause',
    'DISPID_SGRSAddWordTransition',
    'ISpeechGrammarRuleStateTransition', 'SPPS_RESERVED2',
    'DISPID_SVIsUISupported', 'DISPID_SDKDeleteValue',
    'SWPKnownWordPronounceable', 'STSF_FlagCreate',
    'eLEXTYPE_MORPHOLOGY', 'SRAORetainAudio', 'SAFTADPCM_11kHzMono',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechVoiceEvent',
    'DISPID_SGRName', 'SAFTADPCM_11kHzStereo',
    'DISPID_SVSInputSentenceLength', 'eLEXTYPE_USER',
    'DISPID_SPPName', 'DISPID_SPEActualConfidence', 'SVP_16',
    'DISPID_SRCESoundStart', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SGRsAdd', 'SpeechPropertyNormalConfidenceThreshold',
    'SPEI_PHRASE_START', 'SP_VISEME_4', 'SPDATAKEYLOCATION',
    'DISPID_SASNonBlockingIO', 'DISPID_SPPs_NewEnum',
    'SGLexicalNoSpecialChars', 'DISPID_SOTCId', 'ISpXMLRecoResult',
    'SASRun', 'DISPID_SpeechGrammarRules', 'SREStreamStart',
    'DISPID_SLGenerationId', 'SPAR_Unknown', 'ISpRecognizer2',
    'SASPause', 'ISpeechMemoryStream', 'SPPS_Interjection',
    'SVEAudioLevel', 'eLEXTYPE_APP', 'DISPID_SPIReplacements',
    'SPPHRASEPROPERTY', 'SRTEmulated', 'DISPID_SpeechMemoryStream',
    'STSF_AppData', 'SAFTCCITT_uLaw_44kHzStereo',
    'SSSPTRelativeToStart', 'SpeechCategoryAppLexicons',
    'DISPID_SOTIsUISupported', 'SPPS_Noncontent',
    'SAFTADPCM_44kHzMono', 'DISPID_SRRTStreamTime',
    'SPEI_START_SR_STREAM', 'DISPID_SVResume', 'DISPID_SMSGetData',
    'SP_VISEME_13', 'DISPID_SPRulesItem', 'SPGS_ENABLED',
    'DISPID_SASFreeBufferSpace', 'SPPS_Verb',
    'DISPID_SpeechPhraseElement', 'SPRECOGNIZERSTATUS',
    'ISpeechAudioFormat', 'DISPID_SDKSetBinaryValue',
    'SVSFNLPSpeakPunc', 'SLTApp', 'DISPID_SRCEStartStream',
    'SITooFast', 'SPDKL_CurrentUser', 'SPGRAMMARSTATE',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SCSBaseStream',
    'SREPrivate', 'SECFDefault', 'SPEI_MAX_TTS', 'SPSSuppressWord',
    'SPLO_STATIC', 'DISPID_SLPPartOfSpeech', 'SP_VISEME_5',
    'SpNotifyTranslator', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPEI_SR_BOOKMARK', 'DISPID_SLPLangId',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SOTDataKey',
    'DISPID_SpeechAudio', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPPsCount', 'SVP_11', '_ISpeechRecoContextEvents',
    'DISPID_SWFEBlockAlign', 'DISPID_SRRSaveToMemory',
    'DISPIDSPTSI_ActiveLength', 'SpeechEmulationCompareFlags',
    'SGSExclusive', 'SRSActive', 'ISpRecoGrammar', 'DISPID_SBSRead',
    'SPSNoun', 'SPGRAMMARWORDTYPE', 'DISPID_SRSAudioStatus',
    'ISpeechGrammarRule', 'DISPID_SRSSupportedLanguages',
    'DISPID_SPRuleEngineConfidence', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SOTGetDescription', 'SPEI_END_SR_STREAM',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPIRule',
    'DISPID_SVEEnginePrivate', 'ISpeechRecoContext',
    'ISpeechPhraseRule', 'SP_VISEME_19', 'DISPID_SpeechRecoContext',
    ...
    'SPPARTOFSPEECH', 'SPXRO_Alternates_SML', 'ISpPhrase',
    'DISPID_SRCPause', 'Speech_Max_Word_Length',
    'DISPID_SRCRecognizer', 'DISPID_SPPsItem', 'SAFT16kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SGRSTWeight',
    'SVEEndInputStream', 'DISPID_SLPType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpRecognizer3',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SVWaitUntilDone',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRRecognizer', 'SLOStatic',
    'SDA_One_Trailing_Space', 'ISpeechTextSelectionInformation',
    'DISPID_SpeechLexiconWords', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPCIdToPhone', 'SPEI_INTERFERENCE',
    'DISPID_SpeechRecognizer', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPSEMANTICFORMAT', 'DISPID_SRRTTickCount', 'DISPID_SGRAddState',
    ...
    'DISPID_SOTCategory', 'SGDSInactive', 'ISpeechPhraseInfo',
    'SVESentenceBoundary', 'eWORDTYPE_DELETED', 'SpVoice',
    'DISPID_SLPSymbolic', 'SITooQuiet', 'DISPID_SPEsItem',
    'SPSEMANTICERRORINFO', 'SVEViseme', 'DISPID_SPEDisplayAttributes',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechLexiconType',
    'SpeechRecoProfileProperties', 'SpeechCategoryAudioIn',
    'DISPID_SABIBufferSize', 'DISPID_SOTRemoveStorageFileName',
    'SVP_2', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPPNumberOfElements',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechObjectToken',
    'ISpRecoContext', 'SVPAlert', 'ISpEventSink',
    'ISpeechObjectTokens', 'DISPID_SVAlertBoundary',
    'DISPID_SPRuleFirstElement', 'SAFT32kHz16BitStereo',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechInterference', 'ISpeechResourceLoader', '_SPAUDIOSTATE',
    'SpeechRunState', 'SPDKL_DefaultLocation', 'SPINTERFERENCE_NOISE',
    'SRAONone', 'SREPropertyStringChange', 'DISPID_SPILanguageId',
    'DISPID_SRCEPhraseStart', 'DISPID_SpeechLexicon',
    'SpeechVisemeFeature', 'SpeechStreamFileMode',
    'DISPID_SGRsCommit', 'DISPID_SVSCurrentStreamNumber',
    'SPSHORTCUTPAIR', 'DISPID_SRGCmdSetRuleState', 'SREPhraseStart',
    'SVF_Stressed', 'SAFTGSM610_8kHzMono', 'SREAllEvents',
    'SVSFParseMask', 'SpFileStream', 'DISPID_SDKGetBinaryValue',
    'SAFT48kHz8BitMono', 'SPPS_LMA', 'SVEPrivate', 'DISPID_SGRsItem',
    'DISPID_SRCSetAdaptationData', 'DISPID_SGRId', 'SVP_21',
    'DISPID_SOTMatchesAttributes', 'DISPID_SDKGetStringValue',
    'SSFMCreateForWrite', 'SDKLCurrentUser', 'ISpObjectTokenCategory',
    'IInternetSecurityManager', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRCCreateResultFromMemory', 'SpeechAudioFormatGUIDWave',
    'DISPID_SPIEngineId', 'SGRSTTDictation', 'SAFTADPCM_8kHzMono',
    'LONG_PTR', 'SP_VISEME_7', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRCERecognitionForOtherContext', 'SAFTNoAssignedFormat',
    'SRARoot', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpeechPhraseReplacement', 'SGDisplay', 'DISPID_SRGState',
    'ISpeechPhraseAlternates', 'SECNormalConfidence', 'SVSFParseSsml',
    ...
    'DISPID_SGRsFindRule', 'SpObjectToken', 'SpeechCategoryVoices',
    'DISPID_SGRsCount', 'SPLO_DYNAMIC', 'DISPID_SRGCommit',
    'SPWORDTYPE', 'DISPID_SMSAMMHandle', 'SGDSActiveUserDelimited',
    'DISPID_SRState', 'SVPOver', 'SPCT_DICTATION',
    'ISpeechXMLRecoResult', 'SpeechCategoryPhoneConverters',
    'SPEI_VISEME', 'DISPID_SLPsCount', 'SPSInterjection',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT12kHz8BitMono',
    'SpPhraseInfoBuilder', 'ISpeechPhoneConverter', 'SPEI_UNDEFINED',
    'SVP_14', 'SPVPRIORITY', 'SPBINARYGRAMMAR',
    'DISPID_SLGetPronunciations', 'SPEI_WORD_BOUNDARY',
    'SDTReplacement',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFTGSM610_11kHzMono', 'STCAll', 'SECHighConfidence',
    'SPRST_INACTIVE', 'ISpeechLexiconPronunciations', 'SPVISEMES',
    'DISPID_SOTGetStorageFileName', 'SPEI_RESERVED2'
]

_check_version('1.1.14', 1653588654.069194)
